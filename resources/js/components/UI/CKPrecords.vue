        ...
        <v-dialog v-model="delete_dialog" max-width="290">
            <v-card style="background-color: #161d31; color: white;">
                ...
                <v-card-actions>
                    ...
                    <v-btn style="background-color: #7367f0;color:white;"  text @click="delete_ckp()">
                        Iya beneran
                    </v-btn>
                </v-card-actions>
            </v-card>
                    ...
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" sm="6">
                                ...
                                <v-text-field dark dark v-model="edited_angka_kredit" label="Angka Kredit"></v-text-field>
